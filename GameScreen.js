...
class GameScreen extends Component {
    ...
    render() {
        ...
        return <Image resizeMode='cover' source={require('./assets/images/icerink2.jpg')} style={{width: null, height: null, 'flex': 1}}>
            <View style={{flex: 0.12, backgroundColor: '#9198a5',  transform: [{rotate: '0deg'}]}}>
                <View style={styles.container2}>
                        {
                            this.props.opponentDeck.map(function () {
                                return <View style={{width: 55, height: 70, opacity:1, margin:2, borderWidth:1, borderRadius:3}}>
            ...
            <View style={{flex: 0.05, backgroundColor: 'black'}}>
                ...
                <View style={{flex: 0.49, flexDirection: 'row', backgroundColor: 'transparent', justifyContent: 'center'}}>
